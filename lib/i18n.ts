...
const EN: Record<string, string> = {
  ...
  'session.bgJobs': 'Background jobs (systemd)',
  'session.bgJobsSub': '{n} running',
  'runtime.systemd': 'systemd-run',
  'runtime.detached': 'detached (nohup)',
  'job.detachedProcs': '{n} process(es) · detached, no systemd unit (pid {pid})',
  'job.detachedEnded': 'process gone (pid {pid}) · exit status unknown without a unit',
  'job.activeProcs': '{n} process(es) in {unit}',
  'job.result': 'finished ({result})',
  'job.ended': 'ended: {result}',
  ...
  'tree.expandAll': 'Expand the whole tree',
  'tree.collapseAll': 'Collapse the whole tree',
  'ui.filter': 'filter…',
...
const FR: Record<string, string> = {
  ...
  'session.bgJobs': 'Jobs en arrière-plan (systemd)',
  'session.bgJobsSub': '{n} en cours',
  'runtime.systemd': 'systemd-run',
  'runtime.detached': 'détaché (nohup)',
  'job.detachedProcs': '{n} process · détaché, sans unité systemd (pid {pid})',
  'job.detachedEnded': 'process disparu (pid {pid}) · code de sortie inconnu sans unité',
  'job.activeProcs': '{n} process dans {unit}',
  'job.result': 'terminé ({result})',
  'job.ended': 'fin : {result}',
  ...
  'tab.tree': 'Arbre',
  'tab.procs': 'Process ({n})',
  'tree.expandAll': 'Déplier tout l’arbre',
  'tree.collapseAll': 'Replier tout l’arbre',
  'ui.filter': 'filtrer…',
